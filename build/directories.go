...
func GetTargetDocDir(module string) string {

	target := GetTargetDir(module) + "/docs"
	_ = os.MkdirAll(target, os.ModePerm)

	return target
}

func GetTargetDocImagesDir(module string) string {

	target := GetTargetDocDir(module) + "/images"
	_ = os.MkdirAll(target, os.ModePerm)
